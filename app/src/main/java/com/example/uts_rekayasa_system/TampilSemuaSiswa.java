...
public class TampilSemuaSiswa extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void showSiswa(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String induk = jo.getString(konfigurasi.TAG_INDUK);
                String nama = jo.getString(konfigurasi.TAG_NAMA);

                HashMap<String,String> siswa = new HashMap<>();
                siswa.put(konfigurasi.TAG_ID, id);
                siswa.put(konfigurasi.TAG_INDUK, induk);
                siswa.put(konfigurasi.TAG_NAMA, nama);
                list.add(siswa);
            }
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{konfigurasi.TAG_INDUK,konfigurasi.TAG_NAMA},
                new int[]{R.id.induk, R.id.nama});
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String sisId = map.get(konfigurasi.TAG_ID).toString();
        intent.putExtra(konfigurasi.SIS_ID,sisId);
